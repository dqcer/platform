package com.dqcer.platformsystem.config.shiro;

import com.dqcer.platformsystem.web.service.user.UserInfoService;
import com.dqcer.platformsystem.web.vo.user.entity.SysPermissionEntity;
import com.dqcer.platformsystem.web.vo.user.entity.SysRoleEntity;
